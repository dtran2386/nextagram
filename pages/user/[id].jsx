      ...
      <>
        <div class="row text-gray">
          ...
          <div className="col-3 text-center d-flex flex-column align-items-center">
            ...
            <p className="text-gray-50">Posts</p>
          </div>
          <div className="col-3 text-center d-flex flex-column align-items-center">
            <p className="m-0">{moment(userPhotos[0].createdAt).fromNow()}</p>
            <p className="text-gray-50">Active</p>
          </div>
          <div className="col-3 text-center d-flex flex-column align-items-center">
            <button
              type="button"
              className={`btn btn-light p-0 text-left ${
                bookmarked ? " clicked" : ""
              }
              `}
        ...
        <div className="text-gray pt-4">
          ...
          <p className="white-space-break">{userPhotos[0].authorDesc}</p>
        </div>
        ...
        <div className="row row-cols-2">
          {userPhotos.map((photo) => (
            <img className="p-1" src={photo.photo} />
          ))}
        </div>
      </>
    );
