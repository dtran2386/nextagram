...
export default function Card(props) {
  ...
  return (
    <div className="card text-gray bg-light mb-3">
      <div className="card-header pl-2">
        <Link href={"/user/" + photo.userId}>
          <div className="row">
            ...
            <div className="col-10">{photo.location}</div>
          </div>
        </Link>
      </div>
      <img src={photo.photo} className="card-img-top" alt="..." />
        ...
        <div className="row justify-content-between">
          <div className="col-2">
            ...
            >
              <button
                type="button"
                className={`btn btn-light pl-0 pt-0 text-left ${
                  photo.liked ? " clicked" : ""
                }
                `}
                onClick={() => {
              ...
              <Link href={"/user/" + photo.userId}>
                <button type="button" className="btn btn-light pt-0 text-left">
                  <svg
                    width="1em"
                    height="2em"
                    viewBox="0 0 16 16"
          ...
          <div className="col-2">
            <button
              type="button"
              className={`btn btn-light pt-0 text-left ${
